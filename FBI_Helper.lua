...
if enable_autoupdate then
    ...
    if updater_loaded then
        ...
        if autoupdate_loaded then
            Update.json_url = "https://github.com/SAMPer8182/FBI-Helper-autoupdate-file/blob/main/FBI.json" .. tostring(os.clock())
...
function main()
    ...
    sampAddChatMessage('{FFA500}[FBI]: Проверяем скрипт на наличие обновлений.')
    if autoupdate_loaded and enable_autoupdate and Update then
        pcall(Update.check, Update.json_url, Update.prefix, Update.url)
    end
    sampAddChatMessage('{FFA500}[FBI]: у вас установлена актуальная версия 0.4')
